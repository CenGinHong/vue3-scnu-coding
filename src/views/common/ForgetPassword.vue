<template>
  <div :class="style.outer">
    <a-form :class="style.form" :model="resetPasswordState" :rules="rules">
      ...
      <a-form-item>
        <a-button
            :loading="loadingResetPassword" block
            size="large"
            type="primary"
...
<script lang="ts">
import { LockOutlined, MailOutlined, UserOutlined, VerifiedOutlined } from '@ant-design/icons-vue'
